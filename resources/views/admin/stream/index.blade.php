...
<body>
    ...
    <div class="page-container">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="stream_add('添加直播流节点','/admin/stream/add','','400')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加直播流节点</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
        <table class="table table-border table-bordered table-bg">
            ...
            <tbody>
                ...
                <tr class="text-c">
                    ...
                    <td>@if($val -> status == '1')关闭禁播 @elseif($val -> status == '2') 永久禁播 @else 限时禁播 @endif</td>
                    <td>@if($val -> permited_at > 0) {{date('Y-m-d H:i:s',$val -> permited_at)}} @else N/A @endif</td>
                    <td>{{$val -> sort}}</td>
                    <td><a title="编辑" href="javascript:;" onclick="stream_edit('角色编辑','admin-permission-add.html','1','','310')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="javascript:;" onclick="stream_del(this,'1')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
                </tr>
                @endforeach
            </tbody>
        </table>
