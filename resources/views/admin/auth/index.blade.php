...
<body>
    ...
    <div class="page-container">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()"
                    ...
                    onclick="admin_permission_add('添加权限节点','/admin/auth/add','','400')"
        ...
        <table class="table table-border table-bordered table-bg">
            ...
            <tbody>
                @foreach ($data as $val)
                <tr class="text-c">
                    <td><input type="checkbox" value="1" name="{{ $val -> id }}"></td>
                    <td>{{ $val -> id }}</td>
                    <td>{{ $val -> auth_name }}</td>
                    <td>
                        @if ($val -> controller)
                    ...
                    <td><a title="编辑" href="javascript:;"
                            ...
                            title="删除" href="javascript:;" onclick="admin_permission_del(this,'1')" class="ml-5"
